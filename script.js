    ...
    function validateField(field) {
      ...
      if (isRequired) {
        if (fieldType === 'checkbox' && !value) {
          ...
          return false;
        } else if (fieldType !== 'checkbox' && !VALIDATORS.required(value)) {
          showError(field, getErrorMessage(field, 'required'));
          return false;
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Roblox sell משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '157df362-183b-4bae-a9cb-4aa50b6b7024',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '157df362-183b-4bae-a9cb-4aa50b6b7024';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '157df362-183b-4bae-a9cb-4aa50b6b7024';
